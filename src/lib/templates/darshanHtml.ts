...
<nav class="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-margin-desktop py-6 bg-surface/90 border-b border-surface-variant/50 backdrop-blur-md">
    ...
    <div class="hidden md:flex items-center gap-gutter font-label-caps text-label-caps uppercase tracking-wider">
        ...
        <a aria-current="page" class="text-on-background border-b-2 border-tertiary-fixed-dim pb-1 translate-y-[-2px]" href="/darshan">Darshan</a>
        ...
        <a class="text-on-surface-variant hover:text-orange-500 transition-colors duration-300" href="/contact">Contact</a>
    </div>
    ...
    <div class="w-full h-full px-margin-mobile lg:px-margin-desktop flex flex-col lg:flex-row gap-12 lg:gap-16 items-center z-10 relative">
      ...
      <div class="w-full lg:w-1/2 relative h-[50vh] lg:h-[80vh] scroll-anim scroll-fade-up anim-delay-2">
        <div class="absolute inset-0 rounded-[3rem] overflow-hidden shadow-2xl transition-transform duration-700 hover:scale-[1.02]">
          <img src="/images/darshan_hero.jpg" alt="Divine Darshan" class="w-full h-full object-cover">
