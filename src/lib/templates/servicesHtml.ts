...
<main class="bg-surface overflow-hidden pt-24 relative">
  ...
  <!-- Section 2: Annadanam -->
  <section id="annadanam" class="w-full min-h-screen relative flex items-center bg-[#faf8f5] py-20 overflow-hidden">
  ...
  <section id="medical" class="w-full min-h-screen relative flex items-center bg-gradient-to-br from-[#1abc9c]/10 to-surface py-20 overflow-hidden">
  ...
  <section id="vidyalaya" class="w-full min-h-screen relative flex items-center bg-surface py-20 z-10 overflow-hidden">
    <div class="w-full h-full px-margin-mobile lg:px-margin-desktop flex flex-col lg:flex-row gap-12 lg:gap-16 items-center z-10 relative">
      <div class="w-full lg:w-1/2 flex flex-col justify-center scroll-anim scroll-fade-left">
  ...
  <section id="volunteer" class="w-full min-h-screen relative flex items-center bg-gradient-to-br from-[#4a2522] via-[#7d3c2b] to-[#a45437] py-20 z-20 overflow-hidden">
    <div class="w-full h-full px-margin-mobile lg:px-margin-desktop flex flex-col lg:flex-row-reverse gap-12 lg:gap-16 items-center z-10 relative">
      <div class="w-full lg:w-1/2 flex flex-col justify-center scroll-anim scroll-fade-right">
